        ...
        <div className="space-y-3">
          ...
          <Section title="Funções Backend (Serverless)" icon={Zap} color="#f59e0b">
            <SubSection title="vindiIntegration">
              ...
              <InfoBox type="warning">
                A função autentica o usuário via <code className="bg-amber-100 px-1 rounded">api.auth.me()</code> antes de executar qualquer operação. O cancelamento forçado de inadimplentes exige <code className="bg-amber-100 px-1 rounded">role === 'admin'</code>.
              </InfoBox>
            </SubSection>
