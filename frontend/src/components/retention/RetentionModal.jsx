...
// api.entities.RequestAction disponível via SDK
...
export default function RetentionModal({ open, onClose, onSuccess }) {
  ...
  const checkDuplicates = async () => {
    ...
    const existing = await api.entities.RetentionRequest.filter({ cnpj: formData.cnpj });
  ...
  const handleUnificar = async () => {
    ...
    try {
      ...
      await api.entities.RequestAction.create({
