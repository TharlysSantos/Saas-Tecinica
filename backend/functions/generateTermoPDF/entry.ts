...
Deno.serve(async (req) => {
  ...
  const requests = await client.asServiceRole.entities.RetentionRequest.filter({ id: request_id });
  ...
  await client.asServiceRole.entities.RetentionRequest.update(request_id, {
    link_termo,
